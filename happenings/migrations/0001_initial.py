    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ManyToManyField(blank=True, to='happenings.Location', verbose_name='locations')),
                ('tags', models.ManyToManyField(blank=True, to='happenings.Tag', verbose_name='tags')),
            ],
            options={
                'verbose_name': 'event',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cancellations', related_query_name='cancellation', to='happenings.event')),
            ],
        ),
    ]
